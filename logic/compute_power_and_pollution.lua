...
local function compute_for_recipe(recipe, recipe_rate, player_index)
    ...
    if not crafting_machine_name then --manually crafted recipe
        return 0, 0
    end
    ...
    local pollution = global.pollution_by_crafting_machine[crafting_machine.name] * machine_amount * pollution_multiplier * energy_consumption_multiplier
